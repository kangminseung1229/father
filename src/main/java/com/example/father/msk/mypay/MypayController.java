...
public class MypayController {
    ...
    @PostMapping("/insert")
    @Transactional
    public String dataInsert(@RequestParam(required = false) String basicpay, @RequestParam(required = false) String pluspay, 
    ...
    @RequestParam(required = false) Long id){
        ...
        Long memopayToLong = Long.parseLong(memopay,10);
